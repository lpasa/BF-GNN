...
from conv.LinearGatedProtoGCN import LinearGatedProtoGCNConv
                        ...
                        for n_prototypes in n_prototypes_list:
                            ...
                            if not os.path.exists(training_log_dir):
                                ...
                                model = MPGLN(in_channels=data.x.shape[1],
                                                     ...
                                                     n_layer=n_layers,
                                                     conv=LinearGatedProtoGCNConv,
                                                     device=device
                                                     ).to(device)


                                model.set_networks_layer_protopytes_based_on_h(data, train_mask, None)
