...
class LinearGatedHyperGCNConv(MessagePassing):
    ...
    def __init__(self, in_channels,
        ...
        super(LinearGatedHyperGCNConv, self).__init__()
        ...
        self.linear_proj = LinearGatedHyper(in_channels, out_channels, context_dim, n_hyperplanes)
