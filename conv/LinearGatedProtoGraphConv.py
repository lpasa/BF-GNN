...
class LinearGatedGraphConvProto(MessagePassing):

    def __init__(self, in_channels, out_channels, context_dim, n_prototypes, aggr = 'add', **kwargs):
        super(LinearGatedGraphConvProto, self).__init__(aggr=aggr, **kwargs)
        ...
        self.lin_l = LinearGatedProto(in_channels[0], out_channels, context_dim, n_prototypes)
        self.lin_r = LinearGatedProto(in_channels[1], out_channels, context_dim, n_prototypes)
